<section class="content">
    <section class="intro">
        <img class="nosotrosimg" src="css/images/nosotrosimg2.jpg" alt="intro">
        <img class="nosotros_desktop" src="css/images/nosotros_desktop.jpg" alt="intro">
    ...
    <section class="artistas">
        ...
        <div class="bandadeturistas">
            <img class="bandadeturistasimg" src="./css/images/banda_de_turistas.png">
